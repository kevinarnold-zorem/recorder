        ...
        {activePage === 'home' && (
          <>
            ...
            <div className="text-center mt-12">
              ...
              >
                Genere scripts de Cypress, Playwright y Puppeteer a partir de las acciones de su navegador
                (por ejemplo, hacer clic, escribir, scroll).
              </div>
              <button
              ...
              >
                <FontAwesomeIcon
                  ...
                  icon={faCircle}
                />
                &nbsp; Iniciar grabación en la pestaña actual
              </button>
