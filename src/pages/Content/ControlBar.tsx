  ...
  return (
    <>
      {action.type === ActionType.DblClick
        ? `DblClick on ${action.tagName.toLowerCase()} ${getBestSelectorForAction(
            action,
        ...
        : action.type === ActionType.Move
          ? `Move to ${action.tagName.toLowerCase()} ${getBestSelectorForAction(
              action,
              ScriptType.Playwright
            )}`  
          ...
          <div className="p-4">
            ...
            <div className="d-flex justify-between items-center">
              <div className="text-sm text-grey">
                 A continuación se muestra el código generado para esta grabación.
              </div>
